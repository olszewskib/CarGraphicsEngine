...
export class ObjLoader{
	...
	static parseObjText(txt: string){
		txt = txt.trim() + "\n"; //add newline to be able to access last line in the for loop
			...
			aCache: Dict = {},	//Cache Dictionary key = itm array element, val = final index of the vertice
